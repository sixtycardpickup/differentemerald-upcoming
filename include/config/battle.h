...
#define B_FLAG_FORCE_DOUBLE_WILD    FLAG_DOUBLE_WILD    // If this flag is set, all land and surfing wild battles will be double battles.
#define B_SMART_WILD_AI_FLAG        FLAG_SMART_WILD     // If not 0, you can set this flag in a script to enable smart wild pokemon
#define B_FLAG_NO_BAG_USE           FLAG_BAGLESS_BATTLE // If this flag is set, the ability to use the bag in battle is disabled.
...
// Other settings
#define B_DOUBLE_WILD_CHANCE            33         // % chance of encountering two Pokémon in a Wild Encounter.
