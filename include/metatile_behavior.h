...
bool8 MetatileBehavior_IsMudOrMudPuddle(u8);
bool8 MetatileBehavior_IsMudPuddle(u8);
...
bool8 MetatileBehavior_IsMudWildEncounter(u8);
bool8 MetatileBehavior_IsPuddleWildEncounter(u8);
