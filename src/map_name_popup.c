...
static const u8 sRegionMapSectionId_To_PopUpThemeIdMapping[] =
{
    ...
    [MAPSEC_ROUTE_N_1] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_ROUTE_N_1_W_1] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_ROUTE_N_2] = MAPPOPUP_THEME_WOOD,
    ...
    [MAPSEC_ROUTE_EAST_1] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_ROUTE_WEST_1] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_ROUTE_SOUTH_1] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_ROUTE_N_1_E_1] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_ROUTE_N_1_E_2] = MAPPOPUP_THEME_WOOD,
...
static const u8 sRegionMapSectionId_To_PopUpThemeIdMapping_BW[] =
{
    ...
    [MAPSEC_ROUTE_N_1] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_ROUTE_N_1_W_1] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_ROUTE_N_2] = MAPPOPUP_THEME_BW_DEFAULT,
